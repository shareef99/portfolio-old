  ...
  return (
    <Layout>
      ...
      <section>
        ...
        >
          ...
          <div className={Style.skills}>
            <div className={Style.skillsItem}>
              ...
              <div>
                <h3 className={UtilStyles.h3}>Web Development 🧑‍💻</h3>
                <p>
            ...
            <div className={Style.skillsItem}>
              ...
              <div>
                <h3 className={UtilStyles.h3}>leadership 🧑🏻‍🤝‍🧑🏻😊</h3>
                <p>
        ...
        <section id="about" className={`${UtilStyles.containerWithPadding}`}>
          ...
          <div id="about" className={`${Style.aboutSection}`}>
            <ol start={0}>
              ...
              <li>
                I believe in a simple and beautiful design which can attract
                more and more audience.
              </li>
              <li>I'm currently working on React + NextJS.</li>
              <li>
                I am willing to upgrade my self and your company with full
